            ...
            <ul class="flexWrap souzokuMenuList">
                <li class="souzokuMenuList__item">
                  <a href="/souzoku/seizen">
                    ...
                    <a href="/souzoku/seizen" class="button">詳しく見る</a>
                  </a> 
                </li>
                <li class="souzokuMenuList__item">
                  <a href="/souzoku/shinkoku">
                    <div class="radiusImgBox">
                    ...
                    <a href="/souzoku/shinkoku" class="button">詳しく見る</a>
                  </a>
                </li>
                <li class="souzokuMenuList__item">
                  <a href="/souzoku/flow">
                    ...
                    <a href="/souzoku/flow" class="button">詳しく見る</a>
                  </a>
                </li>
                <li class="souzokuMenuList__item">
                  <a href="/souzoku/simulator">
                    <div class="radiusImgBox">
                    ...
                    <a href="/souzoku/simulator" class="button">詳しく見る</a>
                  </a>
                </li>
            </ul>
        </div>
